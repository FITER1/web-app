...
import { HoldAmountOnSavingsAccountComponent } from './saving-account-actions/hold-amount-on-savings-account/hold-amount-on-savings-account.component';
...
@NgModule({
  ...
  declarations: [
    ...
    HoldAmountOnSavingsAccountComponent
  ],
  providers: [DatePipe]
})
