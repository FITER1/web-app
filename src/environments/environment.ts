...
export const environment = {
  ...
  baseApiUrl: JSON.parse(localStorage.getItem('mifosXServerURL')) || 'https://fineractserver:8443',  // For connecting to server running elsewhere update the base API URL
